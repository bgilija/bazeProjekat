...
public class PPrijavaNovihKlijenataKodPrijavljenogPsihoterapeuta extends HBox {
    ...
    private ObservableList<String> olNoviKlijenti;
    private TableView twNoviKlijenti;
    private VBox vb;
    private VBox vb2;
    private HBox hb;

    public PPrijavaNovihKlijenataKodPrijavljenogPsihoterapeuta(){
        napraviElemente();
        dodajElemente();
        dodajAkcije();
    }
    ...
    private void napraviElemente()
    {
        ...
        lbNaslov = new Label("Pregled prijava novih klijenata kod prijavljenog psihoterapeuta");
        btnIzaberi = new Button("Izaberi");
        twNoviKlijenti.setMinWidth(400);
    ...
    private void dodajElemente()
    {
        ...
        vb.getChildren().addAll(hb, twNoviKlijenti);
